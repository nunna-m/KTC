...
python3 -m pre split --whichos linux --path pre/paths.yaml --modalities ['dc','ec','tm']
python3 -m pre split --whichos linux --path pre/paths.yaml --modalities ['ec','pc','tm']
python3 -m pre split --whichos linux --path pre/paths.yaml --modalities ['dc','pc','tm']
python3 -m pre split --whichos linux --path pre/paths.yaml --modalities ['am','dc','tm']
python3 -m pre split --whichos linux --path pre/paths.yaml --modalities ['am','ec','tm']
python3 -m pre split --whichos linux --path pre/paths.yaml --modalities ['am','pc','tm']
...
python3 -m pre split --whichos linux --path pre/paths.yaml --modalities ['am','dc','ec','pc','tm']