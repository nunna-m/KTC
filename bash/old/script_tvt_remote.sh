...
python3 -m ktc.pre split --whichos remote --path ktc/pre/paths.yaml --modalities ['dc','ec','tm']
python3 -m ktc.pre split --whichos remote --path ktc/pre/paths.yaml --modalities ['ec','pc','tm']
python3 -m ktc.pre split --whichos remote --path ktc/pre/paths.yaml --modalities ['dc','pc','tm']
python3 -m ktc.pre split --whichos remote --path ktc/pre/paths.yaml --modalities ['am','dc','tm']
python3 -m ktc.pre split --whichos remote --path ktc/pre/paths.yaml --modalities ['am','ec','tm']
python3 -m ktc.pre split --whichos remote --path ktc/pre/paths.yaml --modalities ['am','pc','tm']
...
python3 -m ktc.pre split --whichos remote --path ktc/pre/paths.yaml --modalities ['am','dc','ec','pc','tm']
