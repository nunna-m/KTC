...
def train_registered(
    ...
    for i in range(cv):
        ...
        trainDS = dataset.train_ds_registered(send_path, modalities, **config['data_options']['train'])
        testDS = dataset.predict_ds_registered(send_path, modalities, **config['data_options']['test'])
