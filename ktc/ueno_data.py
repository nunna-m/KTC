...
def prepare_combined_slices(exam_dir, slice_types):
    ...
    print("Slices shape inside combine mods:",slices.shape)
    return return_dict
...
base(['/home/maanvi/LAB/Datasets/testData-test/datasets/projects/annotation/db3/train'], slice_types=('TRA', 'ADC', 'DWI', 'DCEE', 'DCEL', 'label'), normalize_exams=False)


# parse_exam(exam_dir='/home/maanvi/LAB/Datasets/testData-test/datasets/projects/annotation/db3/train/cancer/054509/01', slice_types=('TRA', 'ADC', 'DWI', 'DCEE', 'DCEL', 'label'))


# prepare_combined_slices(exam_dir='/home/maanvi/LAB/Datasets/testData-test/datasets/projects/annotation/db3/train/cancer/054509/01', slice_types=('TRA', 'ADC', 'DWI', 'DCEE', 'DCEL', 'label'))